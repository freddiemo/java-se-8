...
*/
public class ComplexNumber10 {
	private double real;
	private double imaginary;

	public ComplexNumber10(double real, double imaginary) {
		this.real = real;
	...
	public void add(ComplexNumber10 complexNumber) {
	...
	public void subtract(ComplexNumber10 complexNumber) {
		this.real -= complexNumber.real;
		this.imaginary -= complexNumber.imaginary;
	}
